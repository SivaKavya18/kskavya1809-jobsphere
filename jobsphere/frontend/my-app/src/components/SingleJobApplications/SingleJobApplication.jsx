...
import './SingleJobApplication.css';
      ...
      <div className="job-details">
        <div className="left-column">
          {!editing ? (
            ...
            <>
              <input className='editinput' type="text" name="title" value={updatedJob.title} onChange={handleInputChange} />
              <input className='editinput' type="text" name="location" value={updatedJob.location} onChange={handleInputChange} />
              <input className='editinput' type="text" name="company" value={updatedJob.company} onChange={handleInputChange} />
              <input className='editinput' type="text" name="vacancy" value={updatedJob.vacancy} onChange={handleInputChange} />
              <input className='editinput' type="text" name="expectedSalary" value={updatedJob.expected_salary} onChange={handleInputChange} />
              <textarea className='edittextarea' name="qualifications" value={updatedJob.qualifications} onChange={handleInputChange} />
              <textarea className='edittextarea' name="requirements" value={updatedJob.skills} onChange={handleInputChange} />
            </>
          )}
        </div>
